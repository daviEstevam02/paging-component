...
{
    public sealed class UserDocumentUpdateEvent : Event
    {

        public UserDocumentUpdateEvent(Guid id,
            Guid userId, 
            Guid documentId, 
            Guid companyId, 
            Guid licenseeId,
            string username
            ) : base(EAction.Updated, userId, username, EntitiesContexts.USER_DOCUMENTS)
        {
            Id = id;
            AggregateId = id;
            UserId = userId;
